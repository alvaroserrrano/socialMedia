    ...
    return db
      ...
      .then((doc) => {
        if (
          ...
          // don't send a notification is liking or commenting on their own post
  ...
  .onUpdate((change) => {
    ...
    if (change.before.data().imageUrl !== change.after.data().imageUrl) {
      ...
      return db
        ...
        .then((data) => {
          data.forEach((doc) => {
            // doc refers to each document the user has created
...
exports.onScreamDelete = functions
  ...
  .onDelete((snapshot, context) => {
    // contest has the params that we have in the url
